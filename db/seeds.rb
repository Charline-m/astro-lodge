...
stars = [
  ...
  { name: "Astrovia", category: "Astéroïde", description: "Astéroïde contenant des matériaux rares, utilisés pour l'amélioration de la technologie spatiale.\n\nBienfait pour l'humain : Améliore la durabilité des engins spatiaux.", price: 600, image_url: "https://kinderzeitung.kleinezeitung.at/wp-content/uploads/2024/04/adobestock_245608462-scaled.jpeg" },
  ...
  { name: "Aurora", category: "Etoile", description: "Étoile brillante située près du centre galactique.\n\nBienfait pour l'humain : Aide à la navigation spatiale grâce à ses signaux lumineux.", price: 1000, image_url: "https://t4.ftcdn.net/jpg/01/99/12/75/360_F_199127515_9yC0TpdYCgQPknOTlo4KPuCvzyyuJwXJ.jpg" },
